  ...
  <div class="background min-h-screen flex flex-col">
    ...
    <header class="fixed left-1/2 transform -translate-x-1/2 z-10 pt-6 pb-4">
      <div class="flex justify-center items-center w-fit rounded-3xl backdrop-blur-md text-gray-700 dark:text-gray-100 text-xs sm:text-sm text-nowrap">
        <nav class="flex justify-center items-center sm:gap-3">

          <router-link to="/" class="relative p-3 rounded-xl hover:text-blue-400"
            :class="{ 'text-blue-400': $route.path === '/' }">Inicio
          </router-link>

          <router-link to="/projects" class="relative p-3 rounded-xl hover:text-purple-400"
            :class="{ 'text-purple-400': $route.path === '/projects' }">Proyectos
          </router-link>

          <router-link to="/about" class="relative p-3 rounded-xl hover:text-red-400"
          ...
          <div class="bg-gray-400 block border border-gray-400/40 h-5 rounded-full"></div>


          <button @click="toggleTheme" class="p-3 rounded-xl hover:text-amber-400 cursor-pointer" aria-label="Cambiar tema">
